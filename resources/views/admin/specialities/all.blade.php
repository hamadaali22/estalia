												...
												<tr>													
													...
													<td class="text-center">
														<div class="actions">
															...
															<a class="btn btn-sm bg-success-light" href="{{ url('specialities/'.$_item->id).'/edit' }}"><i class="fe fe-pencil"></i> تعديل</a>
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							 ...
							 <form  method="post" action="{{route('specialities.update','test')}}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<div class="row text-center">
									...
									<div class="col-sm-2">
										<form method="post" action="{{route('specialities.destroy','test')}}">
	                                   		 @csrf
	                                         @method('delete')
	                                         <input type="hidden" name="id" id="cat_id" >
