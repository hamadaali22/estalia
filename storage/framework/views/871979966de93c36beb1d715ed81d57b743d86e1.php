              ...
              for(var i = 0; i < data.length; i++)
              {
                 var outputt = '<button style=" padding: 6px 68px !important;" type="button" class="btn btn-outline-success" ><a href='+'patientpdf/'+data[i].id+'>طباعة </a></button>';
                  ...
                  output += '<td class="text-center">' + data[i].name + '</td>'; 
                 	output += '<td class="text-center">' + data[i].patientapointment[r].date + '</td></tr>';
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/perm/template-rtl/resources/views/admin/patients/report.blade.php ENDPATH**/ ?>