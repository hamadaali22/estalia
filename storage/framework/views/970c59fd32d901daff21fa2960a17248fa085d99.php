					...
					<div class="page-header">
						<div class="row">
							...
							<div class="col-sm-5 col">
								<a href="#Add_Specialities_details" data-toggle="modal" class="btn btn-primary float-right mt-2">أضافة مقال جديد</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/template-rtl/resources/views/admin/articles/all.blade.php ENDPATH**/ ?>