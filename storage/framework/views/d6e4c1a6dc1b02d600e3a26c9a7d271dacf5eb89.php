...
<div class="sidebar" id="sidebar">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="<?php echo e(Request::is('admin/appointment') ? 'active' : ''); ?>"> 
								<a href="appointments"><i class="fe fe-layout"></i> <span>Appointments</span></a>
							</li>
							<li  class="<?php echo e(Request::is('admin/specialities') ? 'active' : ''); ?>"> 
								<a href="specialities"><i class="fe fe-users"></i> <span>Categories</span></a>
							</li>
							<li  class="<?php echo e(Request::is('admin/doctors') ? 'active' : ''); ?>"> 
								<a href="doctors"><i class="fe fe-user-plus"></i> <span>Doctors</span></a>
							</li>
							<li  class="<?php echo e(Request::is('admin/patients') ? 'active' : ''); ?>"> 
								<a href="patients"><i class="fe fe-user"></i> <span>Patients</span></a>
							</li>
							...
							<li  class="<?php echo e(Request::is('admin/articles') ? 'active' : ''); ?>"> 
								<a href="articles"><i class="fe fe-user-plus"></i> <span>Articles</span></a>
							</li>
							<li  class="<?php echo e(Request::is('admin/pannars') ? 'active' : ''); ?>"> 
								<a href="pannars"><i class="fe fe-user-plus"></i> <span>Pannars</span></a>
							</li>
			...
			<!-- /Sidebar<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/doccure-10/template-rtl/resources/views/layout/partials/nav_admin.blade.php ENDPATH**/ ?>