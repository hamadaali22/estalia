    ...
    $.ajax({
       ...
       success:function(data)
       {
          ...
          for(var i = 0; i < data.length; i++)
          {
          	...
          	{
          	  output += '<tr>';
             	output += '<td>' + data[i].docapointment[r].date + '</td>';
             	output += '<td>' + data[i].date + '</td>';
              output += '<td> <a href='+'doctorpdf/'+data[i].id+'>'+  data[i].date +'</a></td></tr>';
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/template-rtl/resources/views/admin/doctor-report.blade.php ENDPATH**/ ?>