								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="password" name="password" class="form-control" class="form-control" value="<?php echo e(old('password')); ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/perm/template-rtl/resources/views/admin/doctors/all.blade.php ENDPATH**/ ?>