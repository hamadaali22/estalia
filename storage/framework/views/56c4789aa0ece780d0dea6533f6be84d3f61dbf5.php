							...
							<div class="profile-header">
								<div class="row align-items-center">
									<div class="col-auto profile-image">
										<a href="#">
											<img class="rounded-circle" alt="User Image" src="<?php echo e(asset('assets_admin/img/doctors/'.$doctors->photo)); ?>">
										</a>
									</div>
							...
							<div class="profile-menu">
								<ul class="nav nav-tabs nav-tabs-solid">
									...
									<li class="nav-item">
										...
										data-target="#password_tab" href="#">Password</a>
									</li>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/template-rtl/resources/views/admin/doctors/doctor-profile.blade.php ENDPATH**/ ?>