...
<div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">بيانت دكتور : <?php echo e($doctors->first_name_ar); ?></h3>
								<ul class="breadcrumb">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="tab-content profile-tab-cont" >
								...
								<div class="tab-pane fade show active " id="services_tab" >										
										<div class="page-header">
												<div class="row">
													<div class="col-sm-7 col-auto">
								                                ...
								                                <table
																	...
																	<tbody>
																		<?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																			<tr>
																				<td class="text-center">
																					<?php echo e($_item->services_name); ?>
																				...
																				<td class="text-center">
																					<div class="actions">
																						<a class="btn btn-sm bg-success-light" data-toggle="modal" 
																						data-services_name ="<?php echo e($_item->services_name); ?>" 
																						data-price ="<?php echo e($_item->price); ?>"					
																						data-catid="<?php echo e($_item->id); ?>" 
								...
								<div class="tab-pane fade show active " id="appointments_tab" >										
										<div class="page-header">
												<div class="row">
													<div class="col-sm-7 col-auto">
														<h3 class="page-title">الخدمات  </h3>
								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" name="services_name" class="form-control" value="<?php echo e(old('services_name')); ?>">
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="form-group">
							 ...
							 <form  method="post" action="<?php echo e(route('doctors.update.service')); ?>" enctype="multipart/form-data">
								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											<label>عنوان الخدمة</label>
											<input type="text" name="services_name" class="form-control" id="servicesName">
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="form-group">
...
// start Services 
    $('#edit_service').on('show.bs.modal', function (event) {
      ...
      modal.find('.modal-body #servicesName').val(services_name);
      modal.find('.modal-body #cat_id').val(cat_id);
    })
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wadialry/zlitn.com/rytert/template-rtl/resources/views/admin/doctors/doctor-profile.blade.php ENDPATH**/ ?>