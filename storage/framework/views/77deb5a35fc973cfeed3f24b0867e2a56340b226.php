	...
	<script src="../assets_admin/js/jquery-3.2.1.min.js"></script>
		...
		<script src="../assets_admin/plugins/bootstrap-rtl/js/bootstrap.min.js"></script>
		...
		<!-- start table another theme--> 
			<script src="../asset/js/table.min.js"></script>
			<!-- Custom Js -->
			<script src="../asset/js/admin.js"></script>
			<script src="../asset/js/pages/tables/jquery-datatable.js"></script>
		<!-- end table from another theme--> 	<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/doccure-10/template-rtl/resources/views/layout/partials/footer_admin-scripts.blade.php ENDPATH**/ ?>