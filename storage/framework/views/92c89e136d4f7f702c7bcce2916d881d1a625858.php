...
<div class="sidebar" id="sidebar">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li  class="<?php echo e(Request::is('specialities') ? 'active' : ''); ?>"> 
								<a href="<?php echo e(url('specialities')); ?>"><i class="fe fe-users"></i> <span>التصنيفات</span></a>
							</li>
			...
			<!-- /Sidebar--><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/perm/templ/resources/views/layout/partials/nav_admin.blade.php ENDPATH**/ ?>