							 ...
							 <form  method="post" action="<?php echo e(route('specialities.update','test')); ?>" enctype="multipart/form-data">
								...
								<div class="row form-row">
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											<label>التخصص عربي </label>
											<input type="text" name="name_en" class="form-control" id="namear" >
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											<label>التخصص انجليزي</label>
											<input type="text" name="name_ar" class="form-control" id="nameen" >
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="form-group">
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/template-rtl/resources/views/admin/specialities/all.blade.php ENDPATH**/ ?>